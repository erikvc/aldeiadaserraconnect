...
$sqlPegaMembers = mysqli_query($conexao, "SELECT * FROM empresas WHERE subcategoria_id = '$subcategoriaID' ORDER BY statusPagamento DESC, nome ASC") or die(mysqli_error($conexao));
