<?php
    ...
    if(isset($_GET['delCategoria'])){
        ...
        $sqlDeletaCategoria = mysqli_query($conexao, "DELETE FROM banners_home WHERE id = '$categoriaID'");
        $removeTemp = unlink('../slide/img/bannersHome/'.$delImage);
...
<section class="container-fluid">
    ...
    <h4 class="margin"><a href="newBannerHome.php">Criar Novo Banner</a></h4>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php
        $sqlPegaCategorias = mysqli_query($conexao, "SELECT * FROM banners_home");  
        while($rowsCategorias = mysqli_fetch_array($sqlPegaCategorias)){
            
      ?>
    <tr>
      <th bgcolor="#F7F7F7" scope="row">1</th>
      <td align="left" valign="middle" bgcolor="#F7F7F7"><img src="../slide/img/bannersHome/<?php echo $rowsCategorias['imagem']; ?>" width="200" height="113" alt=""/></td>
