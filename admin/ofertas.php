<?php
    ...
    if(isset($_GET['delCategoria'])){
        ...
        $sqlDeletaCategoria = mysqli_query($conexao, "DELETE FROM ofertas WHERE id = '$categoriaID'");
        $removeTemp = unlink('../optmedia/images/ofertas/'.$delImage);
        echo '<script>window.location.href="ofertas.php"</script>';
    }
?>
<!doctype html>
...
<section class="container-fluid">
    ...
    <h4 class="margin"><a href="newOfertas.php">Criar Nova Oferta</a></h4>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php
        $sqlPegaCategorias = mysqli_query($conexao, "SELECT * FROM ofertas");  
    ...
    <tr>
      ...
      <td align="center" valign="middle" bgcolor="#F7F7F7"><img src="../optmedia/images/ofertas/<?php echo $rowsCategorias['imagem']; ?>" width="200" height="277" alt=""/></td>
