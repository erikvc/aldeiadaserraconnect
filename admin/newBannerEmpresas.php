<?php
    ...
    if(isset($_POST['acao'])){
		...
		if (array_search($imagesType, $tiposPermitidos) != false) {
				...
				$path 		 = '../slide/img/bannersEmpresas/'.$imgFileName;

				move_uploaded_file($_FILES['imagem']['tmp_name'], $path);
                
				
				$sqlPegaTasks = mysqli_query($conexao, "INSERT INTO banners_empresas (imagem, empresa_id)VALUES('$imgFileName', '$empresa_id')") or die(mysqli_error($conexao));
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <select class="form-control" name="empresa_id" id="sel1">
                  <?php 
                    $sqlPegaCategorias = mysqli_query($conexao, "SELECT * FROM empresas");
