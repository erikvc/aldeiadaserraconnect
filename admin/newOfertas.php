<?php
    ...
    if(isset($_POST['acao'])){
		...
		if (array_search($imagesType, $tiposPermitidos) != false) {
				...
				$path 		 = '../optmedia/images/ofertas/'.$imgFileName;

				move_uploaded_file($_FILES['imagem']['tmp_name'], $path);
                
				
				$sqlPegaTasks = mysqli_query($conexao, "INSERT INTO ofertas (texto, imagem)VALUES('$oferta', '$imgFileName')") or die(mysqli_error($conexao));
    ...
    <div>
        <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="oferta" id="oferta" aria-describedby="oferta" >
          </div>
          <div class="form-group">
