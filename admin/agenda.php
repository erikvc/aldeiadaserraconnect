<?php
    ...
    if(isset($_GET['delCategoria'])){
        ...
        $sqlDeletaCategoria = mysqli_query($conexao, "DELETE FROM agenda WHERE id = '$categoriaID'");
        $removeTemp = unlink('../optmedia/images/agenda/'.$delImage);
...
<section class="container-fluid">
    ...
    <h4 class="margin"><a href="newAgenda.php">Criar Nova Agenda</a></h4>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php
        $sqlPegaCategorias = mysqli_query($conexao, "SELECT * FROM agenda");  
    ...
    <tr>
      ...
      <td align="center" valign="middle" bgcolor="#F7F7F7"><img src="../optmedia/images/agenda/<?php echo $rowsCategorias['imagem']; ?>" width="200" height="277" alt=""/></td>
