<?php
    ...
    if(isset($_POST['acao'])){
		...
		if (array_search($imagesType, $tiposPermitidos) != false) {
				...
				$path 		 = '../optmedia/images/noticias/'.$imgFileName;

				move_uploaded_file($_FILES['imagem']['tmp_name'], $path);
                
				
				$sqlPegaTasks = mysqli_query($conexao, "INSERT INTO noticias (titulo, texto, imagem, dataInserido)VALUES('$titulo', '$texto', '$imgFileName', NOW())") or die(mysqli_error($conexao));
    ...
    <div>
        <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="titulo" id="agenda" aria-describedby="agenda" >
          </div>
          <div class="form-group">
            <label for="comment">Texto:</label>
            <textarea class="form-control" rows="5" name="texto" id="comment"></textarea>
          </div>    
          <div class="form-group">
