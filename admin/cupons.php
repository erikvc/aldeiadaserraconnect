<?php
    ...
    if(isset($_GET['delCategoria'])){
        ...
        $sqlDeletaCategoria = mysqli_query($conexao, "DELETE FROM cupons WHERE id = '$categoriaID'");
        $removeTemp = unlink('../optmedia/images/cupons/'.$delImage);
        echo '<script>window.location.href="cupons.php"</script>';
    }
?>
<!doctype html>
...
<section class="container-fluid">
    ...
    <h4 class="margin"><a href="newCupom.php">Criar Novo Cupom</a></h4>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php
        $sqlPegaCategorias = mysqli_query($conexao, "SELECT * FROM cupons");  
        while($rowsCategorias = mysqli_fetch_array($sqlPegaCategorias)){
            
      ?>
    <tr>
      <th bgcolor="#F7F7F7" scope="row">1</th>
      <td align="left" valign="middle" bgcolor="#F7F7F7"><img src="../optmedia/images/cupons/<?php echo $rowsCategorias['imagem']; ?>" width="200" height="277" alt=""/></td>
