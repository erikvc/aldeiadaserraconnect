<?php
    ...
    if(isset($_POST['acao'])){
		...
		if (array_search($imagesType, $tiposPermitidos) != false) {
				...
				$path 		 = '../optmedia/images/agenda/'.$imgFileName;

				move_uploaded_file($_FILES['imagem']['tmp_name'], $path);
                
				
				$sqlPegaTasks = mysqli_query($conexao, "INSERT INTO agenda (texto, imagem, adicionado)VALUES('$oferta', '$imgFileName', NOW())") or die(mysqli_error($conexao));
    ...
    <div>
        <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="texto" id="agenda" aria-describedby="agenda" >
          </div>
          <div class="form-group">
